...
public class TestingHeuristics{ 
        
        
        
        public static final Log LOG = LogFactory.getLog(TestingHeuristics.class);
...
Double x = hueristics.vertexPredicateMap.get("school").get("international").numberMatchingPredicate;
